        ...
        for(var i = 0; i< numFrames; i++){
            ...
            for(var n = 0; n < 4; n++){
                ...
                if(i < waveStart || i>=numFrames){
                    ...
                    let startAngle = -Math.PI + Math.PI/4 + buffer + movementPerStep*currentStep;
                    ...
                    let startAngle = Math.PI/2 + Math.PI/4 + buffer + movementPerStep*currentStep;
                    ...
                    let movementPerStep = distToGo / totalTimeToComplete;
                    let startAngle = n*(Math.PI/2)+ Math.PI/4 + buffer + movementPerStep*currentStep;
